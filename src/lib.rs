...
///   - If you aren't sure, try `50` and benchmark.
/// - `convergence_speed` - The speed at which Levenberg-Marquardt will attempt to converge
///   - This number should be less than `1.0` or it probably wont improve.
///   - If you aren't sure, try `0.1` and benchmark.
pub fn pnp<E, C, I>(
